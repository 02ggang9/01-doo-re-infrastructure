...
--
-- Table structure for table `member_role_seq`
--

DROP TABLE IF EXISTS `member_role_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2024-01-14 20:46:45
sh-4.4# clear
sh: clear: command not found
sh-4.4# mysqldump --no-data --user=root --password=1234 --host=localhost springBatch BATCH_STEP_EXECUTION_CONTEXT
...
-- Dump completed on 2024-01-14 20:46:53